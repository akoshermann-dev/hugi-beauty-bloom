...
const Footer = () => {
  ...
  return (
    <footer className="bg-salon-dark text-white py-10 mt-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex-1 text-center md:text-left">
            <h4 className="text-xl font-semibold font-playfair mb-2">Hugi szépségfarm</h4>
          ...
          <div className="flex-1 text-center md:text-right">
            <span className="block text-gray-400">Follow us:</span>
            <div className="flex gap-4 mt-1 justify-center md:justify-end">
              <a href="#" aria-label="Facebook" className="hover:text-salon-bronze transition-colors">
              ...
              <a href="#" aria-label="Instagram" className="hover:text-salon-blush transition-colors">
